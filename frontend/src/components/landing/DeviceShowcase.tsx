...
export default function DeviceShowcase() {
  ...
  return (
    <div 
      ...
      className="relative w-full h-[580px] md:h-[650px] flex items-center justify-center perspective-[1000px] cursor-pointer overflow-hidden"
    >
      <motion.div
        style={{
        ...
        className="flex flex-row items-center justify-center gap-6 lg:gap-10 w-full max-w-[900px] h-full"
      >
        {/* ================= LAPTOP MOCKUP (MacBook) ================= */}
        <div className="scale-[0.7] sm:scale-[0.8] md:scale-[0.9] lg:scale-[0.95] origin-center flex-shrink-0">
          <motion.div
            animate={{
              y: [0, -10, 0],
            }}
                ...
                <div className="flex-1 p-4 flex flex-col gap-4 overflow-y-auto no-scrollbar">
                  ...
                  <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                    <div>
                      ...
                      <p className="text-[9px] text-slate-505 font-sans mt-0.5">Section A • 32 Registered Students</p>
                    </div>
                    ...
                    <div className="rounded-xl bg-white border border-slate-200 p-3 flex flex-col gap-2.5 shadow-sm">
                      ...
                      <div className="flex-1 flex flex-col gap-1.5 justify-center">
                        ...
                        <div className="rounded bg-slate-50/50 border border-slate-100 p-1.5">
                          <div className="flex justify-between items-center text-[8px] font-bold text-slate-450">
                    ...
                    <div className="rounded-xl bg-white border border-slate-200 p-3 flex flex-col gap-1.5 shadow-sm">
                      ...
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center justify-between text-[8px]">
                          <span className="text-slate-550">A Grades (90%+)</span>
                          <span className="text-slate-800 font-bold">14 Students</span>
                        </div>
                        <div className="flex items-center justify-between text-[8px]">
                          <span className="text-slate-555">B Grades (80%+)</span>
                          <span className="text-slate-800 font-bold">12 Students</span>
                        </div>
                        <div className="flex items-center justify-between text-[8px]">
                          <span className="text-slate-555">C Grades (70%+)</span>
