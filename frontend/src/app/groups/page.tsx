      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col gap-6 pb-16">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <PillButton
            ...
            onClick={() => alert('Feature coming soon: Link new class Google Classroom or CBSE school portal')}
          >
            Create Class Group
          </PillButton>
        </div>
              ...
              <div className="bg-white border border-veda-card-border rounded-xl shadow-sm overflow-hidden flex flex-col">
                ...
                <div className="p-5 flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-1.5 max-h-[300px] overflow-y-auto font-sans pr-1">
                    ...
                    {selectedGroup.studentCount > selectedGroup.students.length && (
                      <div className="text-center text-[11px] text-gray-400 mt-2 italic">
                        + {selectedGroup.studentCount - selectedGroup.students.length} more students in roster
                      </div>
                    )}
                  </div>
                  ...
                  <PillButton
                    ...
                    onClick={() => alert('Assign Assessment to ' + selectedGroup.name)}
                  >
                    Assign Assessment
                  </PillButton>
                </div>
