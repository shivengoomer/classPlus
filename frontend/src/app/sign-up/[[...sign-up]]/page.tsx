      ...
      <SignUp
        appearance={{
          ...
          elements: {
            ...
            formButtonPrimary: "bg-[#10375C] hover:bg-[#0d2f4f] text-white font-bold text-xs tracking-wide shadow-md shadow-[#10375C]/10 active:scale-95 transition-all rounded-2xl h-11 border-0 w-full mt-2 cursor-pointer",
            formFieldInput: "border border-slate-200 focus:border-[#10375C] focus:ring-1 focus:ring-[#10375C]/20 bg-slate-50/50 hover:bg-slate-50 rounded-2xl px-4 py-2.5 text-sm transition-all w-full",
            formFieldLabel: "text-slate-700 font-bold text-xs mb-1.5",
            footerActionLink: "text-[#10375C] hover:text-[#0d2f4f] font-bold text-xs transition-colors",
